...
onready var trainerenemy_sprite = get_node("Background/enemyBase/trainer_enemy")
onready var trainerenemy_ally_sprite = get_node("Background/enemyBase/trainer_enemy_ally")
onready var trainerplayer_sprite = get_node("Background/playerBase/trainer_player")
onready var trainerplayer_ally_sprite = get_node("Background/playerBase/trainer_player_ally")

onready var pokeball1 = get_node("Background/enemyBase/pokeball1")
onready var pokeball2 = get_node("Background/enemyBase/pokeball2")
