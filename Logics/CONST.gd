...
class BATTLE:
	...
	const FRONT_SINGLE_SPRITE_POS = Vector2(48, -96)
	const FRONT_DOUBLE1_SPRITE_POS = Vector2(96, -96)   #SI HA DE SUMAR EL DOBLE DEL VALOR PLAYERENEMYY DE L ESSENTIALS
	const FRONT_DOUBLE2_SPRITE_POS = Vector2(16, -112)   #SI HA DE SUMAR EL DOBLE DEL VALOR PLAYERENEMYY DE L ESSENTIALS
	
	const BACK_SINGLE_SPRITE_POS = Vector2(176, -96)
	const BACK_DOUBLE1_SPRITE_POS = Vector2(128, -96)   #SI HA DE SUMAR EL DOBLE DEL VALOR PLAYERENEMYY DE L ESSENTIALS
	const BACK_DOUBLE2_SPRITE_POS = Vector2(208, -80)   #SI HA DE SUMAR EL DOBLE DEL VALOR PLAYERENEMYY DE L ESSENTIALS
	
	const BACK_SINGLE_TRAINER_POS = Vector2(220,-80)
	const FRONT_SINGLE_TRAINER_POS = Vector2(60,-56)
